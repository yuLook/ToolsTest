...
import com.yulook.tools.utils.Dp2PxUtils;

import java.security.MessageDigest;

/**
 * 时间：2019/8/2-19:31
 * com.idolmedia.lib_common.widget CenterCropTransform
 * 描述：
 */
public class CenterCropTransform extends CenterCrop {
    ...
    public CenterCropTransform(float radius, CornerType cornerType) {
        super();
        mRadius = Dp2PxUtils.INSTANCE.dip2px(radius);//dp ->px
    ...
    public boolean equals(Object o) {
        return o instanceof CenterCropTransform;
    }
