...
public class PictureSelectionModel {
    ...
    public PictureSelectionModel maxFileSize(int maxFileSize) {
        selectionConfig.maxFileSize = maxFileSize;
        return this;
    }

    /**设置图片的宽高比例*/
    public PictureSelectionModel maxImageScale(int maxImageScale) {
        selectionConfig.maxImageScale = maxImageScale;
        return this;
    }
